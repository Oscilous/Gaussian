...
def create_sliders_buttons():
    ...
    create_slider(window, "Circle_X", 5, 0, 0, 5000)
    create_slider(window, "Circle_Y", 6, 0, 0, 5000)
    create_slider(window, "Circle_Diameter", 7, 0, 0, 2000)
    create_slider(window, "Threshold_upper", 8, 0, 0, 60)
    create_slider(window, "Threshold_lower", 9, 0, 0, 60)
    create_slider(window, "Impurity_pixel_amount", 10, 0, 0, 10000)
    create_slider(window, "detection_threshold", 11, 0, 0, 100)
    create_slider(window, "second_Circle_X", 12, 0, 0, 5000)
    create_slider(window, "second_Circle_Y", 13, 0, 0, 5000)
    create_slider(window, "second_Circle_Diameter", 14, 0, 0, 2000)
    create_slider(window, "second_Threshold_upper", 15, 0, 0, 60)
    create_slider(window, "second_Threshold_lower", 16, 0, 0, 60)
    create_slider(window, "second_Impurity_pixel_amount", 17, 0, 0, 10000)
